...
|2|OCALL in (P2) |[ocall_print_string(str)](https://github.com/bl4ck5un/Town-Crier/blob/78e19969dddf0964da9db1e9d1043e62f231daea/src/Enclave/mbedtls-SGX/trusted/mbedtls_sgx.edl#L25) | [mbedtls_ssl_read()<=buf](https://github.com/bl4ck5un/Town-Crier/blob/33471ff56cb75c9672a51c9d9c20352c96cc3444/win/Enclave/SSLClient.c#L1030)|No|ssl|[Confirmed](https://github.com/bl4ck5un/Town-Crier/issues/69)|Confirmed as debugging code|mbedtls_printf()->printf()->ocall_print_string()|
